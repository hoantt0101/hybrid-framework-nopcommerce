...
import pageObjects.HomePageObjectFactory;
import pageObjects.RegisterPageObjectFactory;

public class Level_05_Register_PageFactory {
	WebDriver driver;
	...
	public void TC_04_Register_Existing_Email() {
		...
		Assert.assertEquals(registerPage.getRegisterWithExistedEmailMessage(), "The specified email already exists");
	}
